    ...
    return (
        <div className="about-me">
            <div className="title-container">
                ...
                <p className="my-title"> Client Solutions Architect | React | JavaScript/HTML/SCSS | NodeJS | ExpressJS | KnexJS | SQL/MySQL | AWS | API integration</p>
            ...
            <div className="about-me-info-container">
                ...
                <div className="info-container">
                    <div className="my-info-text-container">
                        <p className="my-info-text">My name is Mason Clarke, a dedicated and compassionate professional with a strong work ethic. I am committed to promoting a healthy lifestyle through sports and fitness, I have a profound love for travel, and I hold a genuine passion for making a positive impact on others. Currently, I'm privileged to work as a Web Integrator at Plusgrade, an exceptional company in the industry.</p>
